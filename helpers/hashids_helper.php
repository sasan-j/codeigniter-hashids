...
require_once FCPATH . 'sparks/sk-hashids/' . HASHIDS_VERSION . '/vendor/HashGenerator.php';
require_once FCPATH . 'sparks/sk-hashids/' . HASHIDS_VERSION . '/vendor/Hashids.php';
...
{
    function hashids_encode($input, $salt=NULL, $min_hash_length=NULL, $alphabet=NULL)
    {
        $CI =& get_instance();
...
{
    function hashids_decode($hash, $salt='', $min_hash_length=0, $alphabet='')
    {
        $hashids    = hashids_createobject($salt, $min_hash_length, $alphabet);
